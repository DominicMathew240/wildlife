            ...
            <div className="flex flex-row justify-between items-center w-full text-gray-400">
                <div className="flex flex-row justify-center items-center gap-4">
                    <p className="flex flex-row">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 mr-1 text-yellow-300">
                ...
                <div className="flex flex-row items-end gap-4 font-semibold">
                    <Link href="/pages/admin/login">
                        <span className="hover:text-yellow-400">Login</span>
                    </Link>
                    <p>/</p>
                    <Link href="/pages/admin/dashboard">
                        <span className="hover:text-yellow-400">Login Admin</span>
                    </Link>
                    <p>/</p>
                    <Link href="/pages/donation">
                        <span className="hover:text-yellow-400">Donate</span>
                    </Link>
                </div>
            </div>
        </section>
